...
void droid_media_camera_constants_init(DroidMediaCameraConstants *c)
{
    ...
    c->CAMERA_CMD_HISTOGRAM_ON = CAMERA_CMD_HISTOGRAM_ON;
    c->CAMERA_CMD_HISTOGRAM_OFF = CAMERA_CMD_HISTOGRAM_OFF;
    c->CAMERA_CMD_HISTOGRAM_SEND_DATA = CAMERA_CMD_HISTOGRAM_SEND_DATA;
