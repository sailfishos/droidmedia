...
public:
    ...
    void setTransactionState(const Vector<ComposerState>&, const Vector<DisplayState>&, uint32_t, const sp<IBinder>&,
                             const InputWindowCommands&, int64_t, const client_cache_t&, bool,
...
public:
    ...
    int32_t startOperation(const sp<IBinder>&, int32_t, int32_t,
                           const String16&, const std::unique_ptr<String16>&,
                           bool, bool, const String16&) {
        return android::AppOpsManager::MODE_ALLOWED;
    }
...
public:
    ...
    virtual void registerUidObserver(const sp<IUidObserver>&,
                                     const int32_t,
                                     const int32_t,
                                     const String16&) {
    };
