...
public:
    ...
    status_t setTransactionState(const FrameTimelineInfo &, const Vector<ComposerState> &,
        const Vector<DisplayState> &, uint32_t, const sp<IBinder> &, const InputWindowCommands &,
        int64_t, bool, const client_cache_t &, bool, const std::vector<ListenerCallbacks> &,
        uint64_t)
    {
        return BAD_VALUE;
    }
    ...
    status_t setDesiredDisplayModeSpecs(
        const sp<IBinder> &, ui::DisplayModeId, bool, float, float, float, float)
    {
        return BAD_VALUE;
    }
...
public:
    ...
    void finishOperation(
        const sp<IBinder> &, int32_t, int32_t, const String16 &, const std::optional<String16> &)
    {
        // Nothing
    }
...
public:
    ...
    ::android::binder::Status addSensorPrivacyListener(
        const sp<hardware::ISensorPrivacyListener> &) override
    {
        return ::android::binder::Status::ok();
    }
    ...
    ::android::binder::Status setToggleSensorPrivacyForProfileGroup(
        int32_t, int32_t, int32_t, bool) override
    {
        return ::android::binder::Status::ok();
    }
};
