...
public:
    ...
    status_t setDesiredDisplayModeSpecs(const sp<IBinder> &, ui::DisplayModeId, bool, float, float,
                                        float, float)
    {
        return BAD_VALUE;
    }

    status_t getDesiredDisplayModeSpecs(const sp<IBinder> &, ui::DisplayModeId *, bool *, float *,
                                        float *, float *, float *)
    {
        return BAD_VALUE;
    }
...
public:
    ...
    int32_t noteOperation(int32_t, int32_t, const String16 &, const std::optional<String16> &, bool,
                          const String16 &, bool)
    {
        return android::AppOpsManager::MODE_ALLOWED;
    }
    ...
    int32_t startOperation(const sp<IBinder> &, int32_t, int32_t, const String16 &,
                           const std::optional<String16> &, bool, bool, const String16 &, bool)
    {
        return android::AppOpsManager::MODE_ALLOWED;
    }

    void finishOperation(const sp<IBinder> &, int32_t, int32_t, const String16 &,
                         const std::optional<String16> &)
    {
        // Nothing
    }
...
public:
    ...
    ::ndk::ScopedAStatus
    overrideProcessInfo(const std::shared_ptr<::aidl::android::media::IResourceManagerClient> &,
...
public:
    ...
    virtual status_t registerUidObserver(const sp<IUidObserver> &, const int32_t, const int32_t,
                                         const String16 &)
    {
        return BAD_VALUE;
    };
...
public:
    ...
    addSensorPrivacyListener(const sp<hardware::ISensorPrivacyListener> &) override
    {
        return ::android::binder::Status::ok();
    }

    ::android::binder::Status
    removeSensorPrivacyListener(const sp<hardware::ISensorPrivacyListener> &) override
    {
        return ::android::binder::Status::ok();
    }
    ...
    ::android::binder::Status addToggleSensorPrivacyListener(
            const ::android::sp<::android::hardware::ISensorPrivacyListener> &) override
    {
        return ::android::binder::Status::ok();
    }

    ::android::binder::Status removeToggleSensorPrivacyListener(
            const ::android::sp<::android::hardware::ISensorPrivacyListener> &) override
    {
        return ::android::binder::Status::ok();
    }
    ...
    ::android::binder::Status setToggleSensorPrivacyForProfileGroup(int32_t, int32_t, int32_t,
                                                                    bool) override
    {
        return ::android::binder::Status::ok();
    }
