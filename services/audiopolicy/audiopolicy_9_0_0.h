...
public:
    ...
    virtual status_t getInputForAttr(const audio_attributes_t *attr, audio_io_handle_t *input,
        audio_session_t session, pid_t pid, uid_t uid, const String16 &opPackageName,
    ...
    virtual status_t startInput(audio_port_handle_t portId, bool *silenced) { return NO_ERROR; }
