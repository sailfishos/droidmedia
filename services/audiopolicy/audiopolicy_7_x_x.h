...
public:
    ...
    virtual status_t getOutputForAttr(const audio_attributes_t *attr, audio_io_handle_t *output,
                                      ...
                                      uid_t uid, uint32_t samplingRate = 0,
                                      audio_format_t format = AUDIO_FORMAT_DEFAULT,
                                      audio_channel_mask_t channelMask = 0,
                                      audio_output_flags_t flags = AUDIO_OUTPUT_FLAG_NONE,
    ...
    virtual status_t startOutput(audio_io_handle_t output, audio_stream_type_t stream,
                                 audio_session_t session)
    {
        return NO_ERROR;
    }
    virtual status_t stopOutput(audio_io_handle_t output, audio_stream_type_t stream,
                                audio_session_t session)
    {
        return NO_ERROR;
    }
    virtual void releaseOutput(audio_io_handle_t output, audio_stream_type_t stream,
                               audio_session_t session)
    {
        return;
    }
    ...
    status_t doStopOutput(audio_io_handle_t output, audio_stream_type_t stream,
                          audio_session_t session)
    {
        return NO_ERROR;
    }
    void doReleaseOutput(audio_io_handle_t output, audio_stream_type_t stream,
                         audio_session_t session)
    {
        return;
    }
    ...
    virtual status_t SampleRateRequestFocus(audio_io_handle_t output, audio_stream_type_t stream,
                                            int *samplerate)
    {
        return NO_ERROR;
    }
    virtual status_t SampleRateUnrequestFocus(audio_io_handle_t output, audio_stream_type_t stream,
                                              int samplerate)
    {
        return NO_ERROR;
    }
