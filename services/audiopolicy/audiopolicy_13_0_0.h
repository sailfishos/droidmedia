...
public:
    ...
    ::binder::Status getOutput(media::audio::common::AudioStreamType, int32_t *output) override
    {
        *output = 0;
        return ::binder::Status::ok();
    }
    ...
    ::binder::Status getOutputForEffect(const media::EffectDescriptor &, int32_t *output) override
    {
        *output = 0;
        return ::binder::Status::ok();
    }
    ...
    ::binder::Status isSourceActive(media::audio::common::AudioSource, bool *active) override
    {
        *active = false;
        return ::binder::Status::ok();
    }
    ...
    ::binder::Status getAudioPort(int portId, media::AudioPort *_aidl_return) override
    {
        return ::binder::Status::ok();
    }
