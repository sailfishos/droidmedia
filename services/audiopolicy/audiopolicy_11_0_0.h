...
public:
    ...
    virtual status_t getInputForAttr(const audio_attributes_t *attr, audio_io_handle_t *input,
        ...
        const String16 &opPackageName, const audio_config_base_t *config, audio_input_flags_t flags,
        audio_port_handle_t *selectedDeviceId = NULL, audio_port_handle_t *portId = NULL)
    {
        return NO_ERROR;
    }
    ...
    virtual status_t getVolumeIndexForAttributes(
        const audio_attributes_t &attr, int &index, audio_devices_t device)
    {
        return NO_ERROR;
    }
    ...
    virtual status_t getDevicesForAttributes(
        const AudioAttributes &aa, AudioDeviceTypeAddrVector *devices) const
    {
        return NO_ERROR;
    }
    ...
    virtual status_t addSourceDefaultEffect(const effect_uuid_t *type,
        const String16 &opPackageName, const effect_uuid_t *uuid, int32_t priority,
    ...
    virtual status_t setUserIdDeviceAffinities(
        int userId, const Vector<AudioDeviceTypeAddr> &devices)
    {
        return NO_ERROR;
    }
    ...
    virtual status_t getSurroundFormats(unsigned int *numSurroundFormats,
        audio_format_t *surroundFormats, bool *surroundFormatsEnabled, bool reported)
    {
        return NO_ERROR;
    }
    ...
    status_t registerSoundTriggerCaptureStateListener(
        const sp<media::ICaptureStateListener> &listener, bool *result) override
    {
        return NO_ERROR;
    }
