...
public:
    ...
    status_t captureScreen(const sp<IBinder> &, sp<GraphicBuffer> *, bool &, Rect, uint32_t,
                           uint32_t, int32_t, int32_t, bool, Rotation)
    {
        return BAD_VALUE;
    }

    status_t captureScreen(const sp<IBinder> &, sp<GraphicBuffer> *, bool &, Rect, uint32_t,
                           uint32_t, int32_t, int32_t, bool, Rotation, bool)
    {
        return BAD_VALUE;
    }
    ...
    status_t captureLayers(const sp<IBinder> &, sp<GraphicBuffer> *, const Rect &, float, bool)
    {
        return 0;
    }
...
public:
    ...
    sp<ISensorEventConnection> createSensorDirectConnection(const String16 &, uint32_t, int32_t,
                                                            int32_t, const native_handle_t *)
    {
        return sp<ISensorEventConnection>(new FakeSensorEventConnection);
    }

    int setOperationParameter(int32_t, int32_t, const Vector<float> &, const Vector<int32_t> &)
    {
        return 0;
    }
