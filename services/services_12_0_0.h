...
public:
    ...
    android::sp<android::ISensorEventConnection> createSensorEventConnection(
            const android::String8&, int, const android::String16&, const android::String16&) {
...
public:
    ...
    status_t setTransactionState(const FrameTimelineInfo&, const Vector<ComposerState>&,
                             ...
                             const InputWindowCommands&, int64_t, bool, const client_cache_t&, bool,
                             const std::vector<ListenerCallbacks>&, uint64_t) {
        return BAD_VALUE;
    }
    ...
    status_t getAutoLowLatencyModeSupport(const sp<IBinder>&,
                                          bool*) const {
        return BAD_VALUE;
    }
    ...
    status_t captureScreen(const sp<IBinder>&, sp<GraphicBuffer>*, bool&, ui::Dataspace, ui::PixelFormat, const Rect&,
                           uint32_t, uint32_t, bool, ui::Rotation, bool) {
        return BAD_VALUE;
    }

    status_t captureScreen(const sp<IBinder>&, sp<GraphicBuffer>*, const Rect&, uint32_t, uint32_t, bool, ui::Rotation) {
        return BAD_VALUE;
    }
    ...
    status_t getDesiredDisplayConfigSpecs(const sp<IBinder>&, int32_t*, float*, float*, float*, float*) {
        return BAD_VALUE;
    }
    ...
    status_t setDisplayBrightness(const sp<IBinder>&, const gui::DisplayBrightness&) {
        return BAD_VALUE;
    }
...
public:
    ...
    android::binder::Status supportsSensorToggle(int32_t, bool* supported) {
        *supported = false;
    ...
    android::binder::Status addIndividualSensorPrivacyListener(int32_t, int32_t, const sp<hardware::ISensorPrivacyListener>&) {
        return ::android::binder::Status::ok();
    }

    android::binder::Status removeSensorPrivacyListener(const sp<hardware::ISensorPrivacyListener>&) {
        return ::android::binder::Status::ok();
    }

    android::binder::Status removeIndividualSensorPrivacyListener(int32_t, const sp<hardware::ISensorPrivacyListener>&) {
        return ::android::binder::Status::ok();
    }
    ...
    android::binder::Status isIndividualSensorPrivacyEnabled(int32_t, int32_t, bool *enabled) {
        *enabled = false;
        return ::android::binder::Status::ok();
    }
    ...
    android::binder::Status setIndividualSensorPrivacy(int32_t, int32_t, int32_t, bool) {
        return ::android::binder::Status::ok();
    }

    android::binder::Status setIndividualSensorPrivacyForProfileGroup(int32_t, int32_t, int32_t, bool) {
        return ::android::binder::Status::ok();
    }
};
